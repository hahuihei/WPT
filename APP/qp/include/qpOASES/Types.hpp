...
/* TMS320F28335: no <cmath> in C2000 compiler, use <math.h> */
#define __NO_FMATH__
...
/* TMS320F28335: FPU is IEEE-754 single-precision (32-bit float).
 * Enabling this makes real_t = float instead of double,
 * which is ~5x faster on C2000. */
